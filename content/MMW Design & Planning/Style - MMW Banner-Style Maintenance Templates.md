...
## Template Idea Drafts: 

Sorted by category. Where more than one potential option is given for what the final maintenance template could be, the callout will specify if it is "option 1", "2" and so on.
...
> 
> [\{{Uncategorized}}](https://en.wikipedia.org/wiki/Template:Uncategorized) Wikipedia maintenance template

> [!info]+ Draft Ideas -- Categorization Issues:
> 
...
- An entire tag is judged to be un-useful or too insignificant - a tag and its corresponding index page are scheduled for deletion. 
- An article is missing tags. 
- An article contains tags that are not relevant to its content. 

> [!info]+ Draft Ideas -- Tag Issues: 
> 
> #### Missing Tags: 
> 
