...
With your ESP Replacer completed, consider whether the name will be identical to the 'original mod', or have a unique name to distinguish it. See [[Creating a Patch for an ESP#Conventions]] for more information.
